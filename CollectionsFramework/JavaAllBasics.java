...
//
        //typecast
//		double sum2 = (double)firstNumber / (double)secondNumber;
...
//		System.out.println(++a); //increments in curr statement only
//		System.out.println(a);

        System.out.println(a++); //does not update its val, updates in letr values
        System.out.println(a);
		a--;
//		System.out.println(a);
        // assignment =
...
//		while(a <= 100) {
//			a++;
//			if ( a == 65 ) continue;  //will not print 65
//			System.out.println(a);
//		}
